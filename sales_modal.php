  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title text-center" id="myModalLabel">Sales Full Details</h4>
      </div>
      <div class="modal-body">
        <div class="container-fluid">
          ...
          <table class="table table-bordered table-striped sales-details-table">
            <thead>
              <th>Product Name</th>
              <th>Price</th>
...
<style>
  ...
  .sales-details-table thead th {
    background-color: #DFC48B;
    font-weight: bold;
  }
  .sales-details-table tbody tr:nth-child(even) {
    background-color: #f9f9f9;
  }
  .sales-details-table tbody tr:hover {
    background-color: #e9e9e9;
  }
  .sales-details-table tfoot td {
    font-weight: bold;
  }
</style>
